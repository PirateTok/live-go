...
type BadgeStruct struct {
	...
	BadgeScene    int32                    `protobuf:"varint,3,opt,name=badge_scene,json=badgeScene,proto3" json:"badge_scene,omitempty"`
	Display       bool                     `protobuf:"varint,11,opt,name=display,proto3" json:"display,omitempty"`
	LogExtra      *PrivilegeLogExtra       `protobuf:"bytes,12,opt,name=log_extra,json=logExtra,proto3" json:"log_extra,omitempty"`
...
func (x *BadgeStruct) GetBadgeScene() int32 {
	if x != nil {
		return x.BadgeScene
	}
	return 0
...
func (x *BadgeStruct) GetDisplay() bool {
	if x != nil {
		return x.Display
	}
	return false
...
func (x *BadgeStruct) GetLogExtra() *PrivilegeLogExtra {
	if x != nil {
		return x.LogExtra
	}
	return nil
...
// Privilege log extra data (carries level for badges)
...
type User struct {
	...
	UniqueId       string                 `protobuf:"bytes,38,opt,name=unique_id,json=uniqueId,proto3" json:"unique_id,omitempty"`
	DisplayId      string                 `protobuf:"bytes,46,opt,name=display_id,json=displayId,proto3" json:"display_id,omitempty"`
...
func (*BusinessContent) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{74}
}
...
func (*User_FollowInfo) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{6, 0}
}
...
func (*User_FansClub) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{6, 1}
}
...
func (*User_PayGrade) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{6, 2}
}
...
func (*User_Border) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{6, 3}
}
...
func (*User_UserAttr) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{6, 4}
}
...
func (*User_SubscribeInfo) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{6, 5}
}
...
func (*User_OwnRoom) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{6, 6}
}
...
func (*User_FansClub_FansClubData) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{6, 1, 0}
}
...
func (*Goal_GoalStats) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{12, 0}
}
...
func (*Goal_GoalContributor) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{12, 1}
}
...
func (x *LinkMicArmiesItems_ArmiesGroup) Reset() {
	*x = LinkMicArmiesItems_ArmiesGroup{}
	mi := &file_proto_types_proto_msgTypes[93]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_proto_types_proto_rawDesc = "" +
	...
	"isAnimated\"\xa6\x03\n" +
	"\vBadgeStruct\x12!\n" +
	"\fdisplay_type\x18\x01 \x01(\x05R\vdisplayType\x12\x1f\n" +
	"\vbadge_scene\x18\x03 \x01(\x05R\n" +
	"badgeScene\x12\x18\n" +
	"\adisplay\x18\v \x01(\bR\adisplay\x12/\n" +
	"\tlog_extra\x18\f \x01(\v2\x12.PrivilegeLogExtraR\blogExtra\x12-\n" +
	...
	"\x11PrivilegeLogExtra\x12\x14\n" +
	"\x05level\x18\x05 \x01(\tR\x05level\"\xc2\x04\n" +
	"\n" +
	"GiftStruct\x12\x1c\n" +
	...
	"\x0elink_mic_stats\x18% \x01(\x0e2\x0e.LinkmicStatusR\flinkMicStats\x12\x1b\n" +
	"\tunique_id\x18& \x01(\tR\buniqueId\x12\x1d\n" +
	"\n" +
	"display_id\x18. \x01(\tR\tdisplayId\x12\x1b\n" +
...
var file_proto_types_proto_msgTypes = make([]protoimpl.MessageInfo, 94)
var file_proto_types_proto_goTypes = []any{
	...
	(*PrivilegeLogExtra)(nil),              // 29: PrivilegeLogExtra
	(*GiftStruct)(nil),                     // 30: GiftStruct
	(*User)(nil),                           // 31: User
	(*Emote)(nil),                          // 32: Emote
	(*PunishEventInfo)(nil),                // 33: PunishEventInfo
	(*MsgFilter)(nil),                      // 34: MsgFilter
	(*UserIdentity)(nil),                   // 35: UserIdentity
	(*Indicator)(nil),                      // 36: Indicator
	(*Goal)(nil),                           // 37: Goal
	(*Ranking)(nil),                        // 38: Ranking
	(*RankColor)(nil),                      // 39: RankColor
	(*ValueLabel)(nil),                     // 40: ValueLabel
	(*TimeStampContainer)(nil),             // 41: TimeStampContainer
	(*LinkMicArmiesItems)(nil),             // 42: LinkMicArmiesItems
	(*PollOptionInfo)(nil),                 // 43: PollOptionInfo
	(*VoteUser)(nil),                       // 44: VoteUser
	(*PollStartContent)(nil),               // 45: PollStartContent
	(*PollEndContent)(nil),                 // 46: PollEndContent
	(*PollUpdateVotesContent)(nil),         // 47: PollUpdateVotesContent
	(*UserFanTicket)(nil),                  // 48: UserFanTicket
	(*FanTicketRoomNoticeContent)(nil),     // 49: FanTicketRoomNoticeContent
	(*ListUser)(nil),                       // 50: ListUser
	(*LinkerInviteContent)(nil),            // 51: LinkerInviteContent
	(*LinkerReplyContent)(nil),             // 52: LinkerReplyContent
	(*LinkerCreateContent)(nil),            // 53: LinkerCreateContent
	(*LinkerCloseContent)(nil),             // 54: LinkerCloseContent
	(*LinkerEnterContent)(nil),             // 55: LinkerEnterContent
	(*LinkerLeaveContent)(nil),             // 56: LinkerLeaveContent
	(*LinkerCancelContent)(nil),            // 57: LinkerCancelContent
	(*LinkerKickOutContent)(nil),           // 58: LinkerKickOutContent
	(*LinkerLinkedListChangeContent)(nil),  // 59: LinkerLinkedListChangeContent
	(*CohostListChangeContent)(nil),        // 60: CohostListChangeContent
	(*LinkerListChangeContent)(nil),        // 61: LinkerListChangeContent
	(*LinkerMediaChangeContent)(nil),       // 62: LinkerMediaChangeContent
	(*LinkerMicIdxUpdateContent)(nil),      // 63: LinkerMicIdxUpdateContent
	(*LinkerMuteContent)(nil),              // 64: LinkerMuteContent
	(*LinkerRandomMatchContent)(nil),       // 65: LinkerRandomMatchContent
	(*LinkerUpdateUserContent)(nil),        // 66: LinkerUpdateUserContent
	(*LinkerUpdateUserSettingContent)(nil), // 67: LinkerUpdateUserSettingContent
	(*LinkerWaitingListChangeContent)(nil), // 68: LinkerWaitingListChangeContent
	(*LinkerAcceptNoticeContent)(nil),      // 69: LinkerAcceptNoticeContent
	(*LinkerSysKickOutContent)(nil),        // 70: LinkerSysKickOutContent
	(*LinkmicUserToastContent)(nil),        // 71: LinkmicUserToastContent
	(*LinkerSetting)(nil),                  // 72: LinkerSetting
	(*LinkmicUserSettingInfo)(nil),         // 73: LinkmicUserSettingInfo
	(*Player)(nil),                         // 74: Player
	(*LinkPosition)(nil),                   // 75: LinkPosition
	(*Position)(nil),                       // 76: Position
	(*LinkLayerListUser)(nil),              // 77: LinkLayerListUser
	(*AllListUser)(nil),                    // 78: AllListUser
	(*CreateChannelContent)(nil),           // 79: CreateChannelContent
	(*ListChangeContent)(nil),              // 80: ListChangeContent
	(*InviteContent)(nil),                  // 81: InviteContent
	(*ApplyContent)(nil),                   // 82: ApplyContent
	(*PermitApplyContent)(nil),             // 83: PermitApplyContent
	(*ReplyInviteContent)(nil),             // 84: ReplyInviteContent
	(*KickOutContent)(nil),                 // 85: KickOutContent
	(*CancelApplyContent)(nil),             // 86: CancelApplyContent
	(*CancelInviteContent)(nil),            // 87: CancelInviteContent
	(*LeaveContent)(nil),                   // 88: LeaveContent
	(*FinishChannelContent)(nil),           // 89: FinishChannelContent
	(*JoinDirectContent)(nil),              // 90: JoinDirectContent
	(*GroupPlayer)(nil),                    // 91: GroupPlayer
	(*GroupChannelAllUser)(nil),            // 92: GroupChannelAllUser
	(*GroupChannelUser)(nil),               // 93: GroupChannelUser
	(*JoinGroupContent)(nil),               // 94: JoinGroupContent
	(*LeaveJoinGroupContent)(nil),          // 95: LeaveJoinGroupContent
	(*PermitJoinGroupContent)(nil),         // 96: PermitJoinGroupContent
	(*CancelJoinGroupContent)(nil),         // 97: CancelJoinGroupContent
	(*P2PGroupChangeContent)(nil),          // 98: P2PGroupChangeContent
	(*BusinessContent)(nil),                // 99: BusinessContent
	(*Text_TextPiece)(nil),                 // 100: Text.TextPiece
	(*Text_TextFormat)(nil),                // 101: Text.TextFormat
	(*Text_TextPieceGift)(nil),             // 102: Text.TextPieceGift
	(*Text_TextPiecePatternRef)(nil),       // 103: Text.TextPiecePatternRef
	(*Text_TextPieceUser)(nil),             // 104: Text.TextPieceUser
	(*BadgeStruct_ImageBadge)(nil),         // 105: BadgeStruct.ImageBadge
	(*BadgeStruct_TextBadge)(nil),          // 106: BadgeStruct.TextBadge
	(*BadgeStruct_StringBadge)(nil),        // 107: BadgeStruct.StringBadge
	(*User_FollowInfo)(nil),                // 108: User.FollowInfo
	(*User_FansClub)(nil),                  // 109: User.FansClub
	(*User_PayGrade)(nil),                  // 110: User.PayGrade
	(*User_Border)(nil),                    // 111: User.Border
	(*User_UserAttr)(nil),                  // 112: User.UserAttr
	(*User_SubscribeInfo)(nil),             // 113: User.SubscribeInfo
	(*User_OwnRoom)(nil),                   // 114: User.OwnRoom
	(*User_FansClub_FansClubData)(nil),     // 115: User.FansClub.FansClubData
	(*Goal_GoalStats)(nil),                 // 116: Goal.GoalStats
	(*Goal_GoalContributor)(nil),           // 117: Goal.GoalContributor
	(*LinkMicArmiesItems_ArmiesGroup)(nil), // 118: LinkMicArmiesItems.ArmiesGroup
}
var file_proto_types_proto_depIdxs = []int32{
	26,  // 0: Common.display_text:type_name -> Text
	101, // 1: Text.default_format:type_name -> Text.TextFormat
	100, // 2: Text.pieces_list:type_name -> Text.TextPiece
	29,  // 3: BadgeStruct.log_extra:type_name -> PrivilegeLogExtra
	105, // 4: BadgeStruct.image:type_name -> BadgeStruct.ImageBadge
	106, // 5: BadgeStruct.text:type_name -> BadgeStruct.TextBadge
	107, // 6: BadgeStruct.str:type_name -> BadgeStruct.StringBadge
	27,  // 7: GiftStruct.image:type_name -> Image
	27,  // 8: GiftStruct.gift_label_icon:type_name -> Image
	27,  // 9: GiftStruct.icon:type_name -> Image
	27,  // 10: GiftStruct.preview_image:type_name -> Image
	27,  // 11: User.avatar_thumb:type_name -> Image
	27,  // 12: User.avatar_medium:type_name -> Image
	27,  // 13: User.avatar_large:type_name -> Image
	27,  // 14: User.badge_image_list:type_name -> Image
	108, // 15: User.follow_info:type_name -> User.FollowInfo
	110, // 16: User.pay_grade:type_name -> User.PayGrade
	109, // 17: User.fans_club:type_name -> User.FansClub
	111, // 18: User.border:type_name -> User.Border
	27,  // 19: User.avatar_border:type_name -> Image
	112, // 20: User.user_attr:type_name -> User.UserAttr
	7,   // 21: User.link_mic_stats:type_name -> LinkmicStatus
	113, // 22: User.subscribe_info:type_name -> User.SubscribeInfo
	28,  // 23: User.badge_list:type_name -> BadgeStruct
	27,  // 24: Emote.image:type_name -> Image
	2,   // 25: Emote.audit_status:type_name -> AuditStatus
	15,  // 26: Emote.emote_type:type_name -> EmoteType
	16,  // 27: Emote.content_source:type_name -> ContentSource
	17,  // 28: Emote.emote_private_type:type_name -> EmotePrivateType
	117, // 29: Goal.contributors_list:type_name -> Goal.GoalContributor
	116, // 30: Goal.stats:type_name -> Goal.GoalStats
	39,  // 31: Ranking.color:type_name -> RankColor
	40,  // 32: Ranking.details:type_name -> ValueLabel
	118, // 33: LinkMicArmiesItems.battle_groups:type_name -> LinkMicArmiesItems.ArmiesGroup
	44,  // 34: PollOptionInfo.vote_user_list:type_name -> VoteUser
	27,  // 35: VoteUser.avatar_thumb:type_name -> Image
	43,  // 36: PollStartContent.option_list:type_name -> PollOptionInfo
	31,  // 37: PollStartContent.operator:type_name -> User
	43,  // 38: PollEndContent.option_list:type_name -> PollOptionInfo
	31,  // 39: PollEndContent.operator:type_name -> User
	43,  // 40: PollUpdateVotesContent.option_list:type_name -> PollOptionInfo
	48,  // 41: FanTicketRoomNoticeContent.user_fan_ticket_list:type_name -> UserFanTicket
	31,  // 42: ListUser.user:type_name -> User
	31,  // 43: LinkerInviteContent.from_user:type_name -> User
	31,  // 44: LinkerReplyContent.from_user:type_name -> User
	31,  // 45: LinkerReplyContent.to_user:type_name -> User
	50,  // 46: LinkerEnterContent.linked_users_list:type_name -> ListUser
	18,  // 47: LinkerKickOutContent.kickout_reason:type_name -> KickoutReason
	50,  // 48: LinkerListChangeContent.linked_users:type_name -> ListUser
	50,  // 49: LinkerListChangeContent.applied_users:type_name -> ListUser
	50,  // 50: LinkerListChangeContent.connecting_users:type_name -> ListUser
	31,  // 51: LinkerRandomMatchContent.user:type_name -> User
	26,  // 52: LinkmicUserToastContent.display_text:type_name -> Text
	20,  // 53: LinkmicUserSettingInfo.applier_sort_setting:type_name -> LinkmicApplierSortSetting
	75,  // 54: Position.link:type_name -> LinkPosition
	31,  // 55: LinkLayerListUser.user:type_name -> User
	76,  // 56: LinkLayerListUser.pos:type_name -> Position
	77,  // 57: AllListUser.linked_list:type_name -> LinkLayerListUser
	77,  // 58: AllListUser.applied_list:type_name -> LinkLayerListUser
	77,  // 59: AllListUser.invited_list:type_name -> LinkLayerListUser
	77,  // 60: AllListUser.ready_list:type_name -> LinkLayerListUser
	74,  // 61: CreateChannelContent.owner:type_name -> Player
	22,  // 62: ListChangeContent.type:type_name -> TextType
	78,  // 63: ListChangeContent.list:type_name -> AllListUser
	74,  // 64: InviteContent.invitor:type_name -> Player
	76,  // 65: InviteContent.pos:type_name -> Position
	31,  // 66: InviteContent.invitee:type_name -> User
	31,  // 67: InviteContent.operator:type_name -> User
	74,  // 68: ApplyContent.applier:type_name -> Player
	74,  // 69: PermitApplyContent.permiter:type_name -> Player
	76,  // 70: PermitApplyContent.applier_pos:type_name -> Position
	19,  // 71: PermitApplyContent.reply_status:type_name -> ReplyStatus
	31,  // 72: PermitApplyContent.applier:type_name -> User
	31,  // 73: PermitApplyContent.operator:type_name -> User
	74,  // 74: ReplyInviteContent.invitee:type_name -> Player
	19,  // 75: ReplyInviteContent.reply_status:type_name -> ReplyStatus
	76,  // 76: ReplyInviteContent.invitee_pos:type_name -> Position
	74,  // 77: ReplyInviteContent.invite_operator_user:type_name -> Player
	74,  // 78: KickOutContent.offliner:type_name -> Player
	18,  // 79: KickOutContent.kickout_reason:type_name -> KickoutReason
	74,  // 80: CancelApplyContent.applier:type_name -> Player
	74,  // 81: CancelInviteContent.invitor:type_name -> Player
	74,  // 82: CancelInviteContent.invitee:type_name -> Player
	74,  // 83: LeaveContent.leaver:type_name -> Player
	74,  // 84: FinishChannelContent.owner:type_name -> Player
	77,  // 85: JoinDirectContent.joiner:type_name -> LinkLayerListUser
	78,  // 86: JoinDirectContent.all_users:type_name -> AllListUser
	31,  // 87: GroupPlayer.user:type_name -> User
	93,  // 88: GroupChannelAllUser.user_list:type_name -> GroupChannelUser
	21,  // 89: GroupChannelUser.status:type_name -> GroupStatus
	22,  // 90: GroupChannelUser.type:type_name -> TextType
	78,  // 91: GroupChannelUser.all_user:type_name -> AllListUser
	92,  // 92: JoinGroupContent.group_user:type_name -> GroupChannelAllUser
	91,  // 93: JoinGroupContent.join_user:type_name -> GroupPlayer
	22,  // 94: JoinGroupContent.type:type_name -> TextType
	91,  // 95: LeaveJoinGroupContent.operator:type_name -> GroupPlayer
	91,  // 96: PermitJoinGroupContent.approver:type_name -> GroupPlayer
	23,  // 97: PermitJoinGroupContent.agree_status:type_name -> AgreeStatus
	22,  // 98: PermitJoinGroupContent.type:type_name -> TextType
	92,  // 99: PermitJoinGroupContent.group_user:type_name -> GroupChannelAllUser
	91,  // 100: CancelJoinGroupContent.leaver_list:type_name -> GroupPlayer
	91,  // 101: CancelJoinGroupContent.operator:type_name -> GroupPlayer
	22,  // 102: CancelJoinGroupContent.type:type_name -> TextType
	92,  // 103: P2PGroupChangeContent.group_user:type_name -> GroupChannelAllUser
	101, // 104: Text.TextPiece.format:type_name -> Text.TextFormat
	104, // 105: Text.TextPiece.user_value:type_name -> Text.TextPieceUser
	102, // 106: Text.TextPiece.gift_value:type_name -> Text.TextPieceGift
	103, // 107: Text.TextPiece.pattern_ref_value:type_name -> Text.TextPiecePatternRef
	31,  // 108: Text.TextPieceUser.user:type_name -> User
	27,  // 109: BadgeStruct.ImageBadge.image:type_name -> Image
	115, // 110: User.FansClub.data:type_name -> User.FansClub.FansClubData
	27,  // 111: User.PayGrade.diamond_icon:type_name -> Image
	27,  // 112: User.PayGrade.icon:type_name -> Image
	27,  // 113: User.Border.icon:type_name -> Image
	27,  // 114: Goal.GoalContributor.avatar:type_name -> Image
	31,  // 115: LinkMicArmiesItems.ArmiesGroup.users:type_name -> User
...
func file_proto_types_proto_init() {
	...
	file_proto_types_proto_msgTypes[75].OneofWrappers = []any{
